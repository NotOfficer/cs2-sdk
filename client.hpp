...
{
private:
	[[maybe_unused]] uint8_t __pad0540[0x1058]; // 0x540
public:
	// MNetworkEnable
...
public:
	...
	// MNetworkEnable
	CStrongHandle<InfoForResourceTypeCTextureBase> m_hLightProbeDirectLightIndicesTexture; // 0x15b8	
	// MNetworkEnable
	CStrongHandle<InfoForResourceTypeCTextureBase> m_hLightProbeDirectLightScalarsTexture; // 0x15c0	
	// MNetworkEnable
	CStrongHandle<InfoForResourceTypeCTextureBase> m_hLightProbeDirectLightShadowsTexture; // 0x15c8	
	// MNetworkEnable
...
public:
	// MNetworkEnable
	int32_t m_nHandshake; // 0x15ec	
	// MNetworkEnable
	int32_t m_nEnvCubeMapArrayIndex; // 0x15f0	
	// MNetworkEnable
	int32_t m_nPriority; // 0x15f4	
	// MNetworkEnable
...
public:
	// MNetworkEnable
	float m_flEdgeFadeDist; // 0x15fc	
	// MNetworkEnable
	Vector m_vEdgeFadeDists; // 0x1600	
	// MNetworkEnable
	int32_t m_nLightProbeSizeX; // 0x160c	
	// MNetworkEnable
	int32_t m_nLightProbeSizeY; // 0x1610	
	// MNetworkEnable
	int32_t m_nLightProbeSizeZ; // 0x1614	
	// MNetworkEnable
	int32_t m_nLightProbeAtlasX; // 0x1618	
	// MNetworkEnable
	int32_t m_nLightProbeAtlasY; // 0x161c	
	// MNetworkEnable
	int32_t m_nLightProbeAtlasZ; // 0x1620	
private:
...
{
private:
	[[maybe_unused]] uint8_t __pad0540[0x80]; // 0x540
public:
	// MNetworkEnable
...
public:
	// MNetworkEnable
	float m_flInfluenceRadius; // 0x5cc	
	// MNetworkEnable
...
public:
	...
	// MNetworkEnable
	int32_t m_nPriority; // 0x5f4	
	// MNetworkEnable
	float m_flEdgeFadeDist; // 0x5f8	
	// MNetworkEnable
	Vector m_vEdgeFadeDists; // 0x5fc	
	// MNetworkEnable
	float m_flDiffuseScale; // 0x608	
	// MNetworkEnable
...
private:
	[[maybe_unused]] uint8_t __pad0611[0xf]; // 0x611
public:
	// MNetworkEnable
...
{
private:
	[[maybe_unused]] uint8_t __pad0540[0xfd8]; // 0x540
public:
	// MNetworkEnable
...
public:
	// MNetworkEnable
	int32_t m_nHandshake; // 0x1554	
	// MNetworkEnable
	int32_t m_nPriority; // 0x1558	
	// MNetworkEnable
...
public:
	// MNetworkEnable
	int32_t m_nLightProbeSizeX; // 0x1560	
	// MNetworkEnable
	int32_t m_nLightProbeSizeY; // 0x1564	
	// MNetworkEnable
	int32_t m_nLightProbeSizeZ; // 0x1568	
	// MNetworkEnable
	int32_t m_nLightProbeAtlasX; // 0x156c	
	// MNetworkEnable
	int32_t m_nLightProbeAtlasY; // 0x1570	
	// MNetworkEnable
	int32_t m_nLightProbeAtlasZ; // 0x1574	
private:
...
public:
	...
	// MNetworkEnable
	int32_t m_nBounces; // 0x1080	
private:
	[[maybe_unused]] uint8_t __pad1084[0x4]; // 0x1084
public:
	// MNetworkEnable
	CStrongHandle<InfoForResourceTypeIParticleSystemDefinition> m_nExplodeEffectIndex; // 0x1088	
	// MNetworkEnable
	int32_t m_nExplodeEffectTickBegin; // 0x1090	
	// MNetworkEnable
...
public:
	...
	float m_flFOVSensitivityAdjust; // 0x121c	
	float m_flMouseSensitivity; // 0x1220	
	Vector m_vOldOrigin; // 0x1224	
	float m_flOldSimulationTime; // 0x1230	
	int32_t m_nLastExecutedCommandNumber; // 0x1234	
	int32_t m_nLastExecutedCommandTick; // 0x1238	
	// MNetworkEnable
...
public:
	...
	HSequence m_thirdPersonSequences[7]; // 0x1618	
private:
	[[maybe_unused]] uint8_t __pad1634[0x1c]; // 0x1634
public:
	...
	float m_flCrosshairDistance; // 0x1658	
	int32_t m_iAmmoLastCheck; // 0x165c	
	int32_t m_iAlpha; // 0x1660	
	int32_t m_iScopeTextureID; // 0x1664	
	int32_t m_iCrosshairTextureID; // 0x1668	
	float m_flGunAccuracyPosition; // 0x166c	
	// MNetworkEnable
	// MNetworkUserGroup "LocalWeaponExclusive"
	uint32_t m_nViewModelIndex; // 0x1670	
...
public:
	...
	float m_flTurningInaccuracyDelta; // 0x16ac	
	Vector m_vecTurningInaccuracyEyeDirLast; // 0x16b0	
	float m_flTurningInaccuracy; // 0x16bc	
	// MNetworkEnable
	float m_fAccuracyPenalty; // 0x16c0	
	GameTime_t m_flLastAccuracyUpdateTime; // 0x16c4	
	float m_fAccuracySmoothedForZoom; // 0x16c8	
	GameTime_t m_fScopeZoomEndTime; // 0x16cc	
	// MNetworkEnable
	int32_t m_iRecoilIndex; // 0x16d0	
	// MNetworkEnable
	float m_flRecoilIndex; // 0x16d4	
	// MNetworkEnable
...
public:
	...
	// MNetworkEnable
	float m_flPostponeFireReadyFrac; // 0x16e0	
	// MNetworkEnable
...
private:
	[[maybe_unused]] uint8_t __pad16ee[0x2]; // 0x16ee
public:
	// MNetworkEnable
	GameTime_t m_flTimeSilencerSwitchComplete; // 0x16f0	
	// MNetworkEnable
	int32_t m_iOriginalTeamNumber; // 0x16f4	
	float m_flNextAttackRenderTimeOffset; // 0x16f8	
private:
	[[maybe_unused]] uint8_t __pad16fc[0x84]; // 0x16fc
public:
...
private:
	[[maybe_unused]] uint8_t __pad17b0[0x1c]; // 0x17b0
public:
...
private:
	[[maybe_unused]] uint8_t __pad1988[0x78]; // 0x1988
public:
...
public:
	// MNetworkEnable
	int32_t m_zoomLevel; // 0x1a10	
	// MNetworkEnable
	int32_t m_iBurstShotsRemaining; // 0x1a14	
	int32_t m_iSilencerBodygroup; // 0x1a18	
private:
	[[maybe_unused]] uint8_t __pad1a1c[0xc]; // 0x1a1c
public:
	int32_t m_silencedModelIndex; // 0x1a28	
...
private:
	[[maybe_unused]] uint8_t __pad1a42[0x6]; // 0x1a42
public:
	// MNetworkEnable
	EntitySpottedState_t m_entitySpottedState; // 0x1a48	
	int32_t m_nSpotRules; // 0x1a60	
	bool m_bPlayedArmingBeeps[7]; // 0x1a64	
...
public:
	// MNetworkEnable
	float m_flDisplayHealth; // 0x1a30	
};
...
public:
	// MNetworkEnable
	int32_t m_nDecoyShotTick; // 0x1100	
	int32_t m_nClientLastKnownDecoyShotTick; // 0x1104	
private:
	[[maybe_unused]] uint8_t __pad1108[0x20]; // 0x1108
public:
...
{
private:
	[[maybe_unused]] uint8_t __pad1100[0x8]; // 0x1100
public:
	// MNetworkEnable
	int32_t m_nSmokeEffectTickBegin; // 0x1108	
	// MNetworkEnable
...
public:
	...
	// MNetworkEnable
	float m_flThrowStrength; // 0x1a1c	
	// MNetworkEnable
	float m_flThrowStrengthApproach; // 0x1a20	
	// MNetworkEnable
...
private:
	[[maybe_unused]] uint8_t __pad1a11[0x3]; // 0x1a11
public:
	// MNetworkEnable
...
public:
	float m_fRenderingClipPlane[4]; // 0x1280	
	int32_t m_nLastClipPlaneSetupFrame; // 0x1290	
...
private:
	[[maybe_unused]] uint8_t __pad12ae[0x2]; // 0x12ae
public:
	C_CSWeaponBase* m_pClippingWeapon; // 0x12b0	
	CSPlayerState m_previousPlayerState; // 0x12b8	
	float m_flLastCollisionCeiling; // 0x12bc	
	float m_flLastCollisionCeilingChangeTime; // 0x12c0	
private:
	[[maybe_unused]] uint8_t __pad12c4[0x1c]; // 0x12c4
public:
	GameTime_t m_grenadeParameterStashTime; // 0x12e0	
	bool m_bGrenadeParametersStashed; // 0x12e4	
private:
	[[maybe_unused]] uint8_t __pad12e5[0x3]; // 0x12e5
public:
	QAngle m_angStashedShootAngles; // 0x12e8	
	Vector m_vecStashedGrenadeThrowPosition; // 0x12f4	
	Vector m_vecStashedVelocity; // 0x1300	
	QAngle m_angShootAngleHistory[2]; // 0x130c	
	Vector m_vecThrowPositionHistory[2]; // 0x1324	
	Vector m_vecVelocityHistory[2]; // 0x133c	
private:
...
public:
	...
	// MNetworkPriority "32"
	float m_flSlopeDropOffset; // 0x1370	
private:
...
public:
	...
	// MNetworkPriority "32"
	float m_flSlopeDropHeight; // 0x1380	
private:
	[[maybe_unused]] uint8_t __pad1384[0xc]; // 0x1384
public:
	// MNetworkEnable
...
private:
	[[maybe_unused]] uint8_t __pad13ab[0x1]; // 0x13ab
public:
	// MNetworkEnable
...
private:
	[[maybe_unused]] uint8_t __pad13c6[0x2]; // 0x13c6
public:
	// MNetworkEnable
	float m_fMolotovUseTime; // 0x13c8	
	// MNetworkEnable
	float m_fMolotovDamageTime; // 0x13cc	
	// MNetworkEnable
	int32_t m_nWhichBombZone; // 0x13d0	
	// MNetworkEnable
...
public:
	// MNetworkEnable
	int32_t m_iThrowGrenadeCounter; // 0x13d8	
	// MNetworkEnable
...
public:
	// MNetworkEnable
	float m_flGuardianTooFarDistFrac; // 0x13e0	
	// MNetworkEnable
	GameTime_t m_flDetectedByEnemySensorTime; // 0x13e4	
	float m_flNextGuardianTooFarWarning; // 0x13e8	
...
public:
	// MNetworkEnable
	float m_flLowerBodyYawTarget; // 0x13f8	
	// MNetworkEnable
...
public:
	...
	// MNetworkEnable
	int32_t m_iAddonBits; // 0x1408	
	// MNetworkEnable
	int32_t m_iPrimaryAddon; // 0x140c	
	// MNetworkEnable
	int32_t m_iSecondaryAddon; // 0x1410	
	// MNetworkEnable
	int32_t m_iProgressBarDuration; // 0x1414	
	// MNetworkEnable
	float m_flProgressBarStartTime; // 0x1418	
	// MNetworkEnable
	int32_t m_iDirection; // 0x141c	
	// MNetworkEnable
	int32_t m_iShotsFired; // 0x1420	
	// MNetworkEnable
...
public:
	...
	int32_t m_iHealthBarRenderMaskIndex; // 0x149c	
	float m_flHealthFadeValue; // 0x14a0	
	float m_flHealthFadeAlpha; // 0x14a4	
	int32_t m_nMyCollisionGroup; // 0x14a8	
	float m_ignoreLadderJumpTime; // 0x14ac	
...
public:
	float m_flDeathCCWeight; // 0x14e8	
	bool m_bOldIsScoped; // 0x14ec	
private:
	[[maybe_unused]] uint8_t __pad14ed[0x3]; // 0x14ed
public:
	float m_flPrevRoundEndTime; // 0x14f0	
	float m_flPrevMatchEndTime; // 0x14f4	
	// MNetworkEnable
	uint16_t m_unCurrentEquipmentValue; // 0x14f8	
	// MNetworkEnable
	uint16_t m_unRoundStartEquipmentValue; // 0x14fa	
	// MNetworkEnable
	uint16_t m_unFreezetimeEndEquipmentValue; // 0x14fc	
private:
	[[maybe_unused]] uint8_t __pad14fe[0x2]; // 0x14fe
public:
	Vector m_vecThirdPersonViewPositionOverride; // 0x1500	
	// MNetworkEnable
	int32_t m_nHeavyAssaultSuitCooldownRemaining; // 0x150c	
	// MNetworkEnable
	int32_t m_ArmorValue; // 0x1510	
private:
...
private:
	[[maybe_unused]] uint8_t __pad1524[0xc]; // 0x1524
public:
	float m_fNextThinkPushAway; // 0x1530	
	...
	// MNetworkEnable
	int32_t m_nLastConcurrentKilled; // 0x153c	
	// MNetworkEnable
	int32_t m_nDeathCamMusic; // 0x1540	
...
private:
	[[maybe_unused]] uint8_t __pad1580[0x4]; // 0x1580
public:
	float m_flCurrentMusicStartTime; // 0x1584	
	float m_flMusicRoundStartTime; // 0x1588	
	bool m_bDeferStartMusicOnWarmup; // 0x158c	
private:
	[[maybe_unused]] uint8_t __pad158d[0x3]; // 0x158d
public:
	// MNetworkEnable
	int32_t m_cycleLatch; // 0x1590	
	float m_serverIntendedCycle; // 0x1594	
	// MNetworkEnable
	// MNetworkChangeCallback "RecvProxy_PatchEconIndices"
	uint32_t m_vecPlayerPatchEconIndices[5]; // 0x1598	
private:
	[[maybe_unused]] uint8_t __pad15ac[0x8]; // 0x15ac
public:
	// MNetworkEnable
...
public:
	float m_nextTaserShakeTime; // 0x15b8	
	float m_firstTaserShakeTime; // 0x15bc	
	float m_flLastSmokeOverlayAlpha; // 0x15c0	
	Vector m_vLastSmokeOverlayColor; // 0x15c4	
	ParticleIndex_t m_nPlayerSmokedFx; // 0x15d0	
	float m_flNextMagDropTime; // 0x15d4	
	int32_t m_nLastMagDropAttachmentIndex; // 0x15d8	
private:
...
private:
	[[maybe_unused]] uint8_t __pad161c[0x1c]; // 0x161c
public:
	// MNetworkEnable
	EntitySpottedState_t m_entitySpottedState; // 0x1638	
	// MNetworkEnable
	int32_t m_nSurvivalTeamNumber; // 0x1650	
	bool m_bGuardianShouldSprayCustomXMark; // 0x1654	
	bool m_bHasDeathInfo; // 0x1655	
private:
	[[maybe_unused]] uint8_t __pad1656[0x2]; // 0x1656
public:
	float m_flDeathInfoTime; // 0x1658	
...
public:
	float m_flLandseconds; // 0x16ec	
	float m_flOldFallVelocity; // 0x16f0	
	// MNetworkEnable
	char m_szLastPlaceName[18]; // 0x16f4	
	bool m_bPrevDefuser; // 0x1706	
	bool m_bPrevHelmet; // 0x1707	
	int32_t m_nPrevArmorVal; // 0x1708	
	int32_t m_nPrevGrenadeAmmoCount; // 0x170c	
	uint32_t m_unPreviousWeaponHash; // 0x1710	
	uint32_t m_unWeaponHash; // 0x1714	
	// MNetworkEnable
...
private:
	[[maybe_unused]] uint8_t __pad176b[0x1]; // 0x176b
public:
	// MNetworkEnable
...
private:
	[[maybe_unused]] uint8_t __pad1774[0x114]; // 0x1774
public:
	// MNetworkEnable
	// MNetworkChangeCallback "OnRetakesOfferingChanged"
	int32_t m_iRetakesOffering; // 0x1888	
	// MNetworkEnable
	// MNetworkChangeCallback "OnRetakesOfferingCardChanged"
	int32_t m_iRetakesOfferingCard; // 0x188c	
	// MNetworkEnable
	bool m_bRetakesHasDefuseKit; // 0x1890	
	// MNetworkEnable
	bool m_bRetakesMVPLastRound; // 0x1891	
private:
	[[maybe_unused]] uint8_t __pad1892[0x2]; // 0x1892
public:
	// MNetworkEnable
	int32_t m_iRetakesMVPBoostItem; // 0x1894	
	// MNetworkEnable
	loadout_slot_t m_RetakesMVPBoostExtraUtility; // 0x1898	
private:
	[[maybe_unused]] uint8_t __pad189c[0x1c]; // 0x189c
public:
...
private:
	[[maybe_unused]] uint8_t __pad1d09[0x3]; // 0x1d09
public:
	// MNetworkEnable
	int32_t m_nRagdollDamageBone; // 0x1d0c	
	// MNetworkEnable
	Vector m_vRagdollDamageForce; // 0x1d10	
	// MNetworkEnable
	Vector m_vRagdollDamagePosition; // 0x1d1c	
	// MNetworkEnable
	char m_szRagdollDamageWeaponName[64]; // 0x1d28	
	// MNetworkEnable
...
private:
	[[maybe_unused]] uint8_t __pad1d78[0x608]; // 0x1d78
public:
	bool m_bLastHeadBoneTransformIsValid; // 0x2380	
private:
	[[maybe_unused]] uint8_t __pad2381[0x3]; // 0x2381
public:
	GameTime_t m_lastLandTime; // 0x2384	
	bool m_bOnGroundLastTick; // 0x2388	
private:
	[[maybe_unused]] uint8_t __pad2389[0x1b]; // 0x2389
public:
	// MNetworkEnable
...
public:
	...
	float m_flInitialModelScale; // 0x23c8	
};
